...
// required int32 groupID = 2;
inline bool FieldObjectBasicInfo::has_groupid() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void FieldObjectBasicInfo::set_has_groupid() {
  _has_bits_[0] |= 0x00000002u;
}
inline void FieldObjectBasicInfo::clear_has_groupid() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void FieldObjectBasicInfo::clear_groupid() {
  groupid_ = 0;
  clear_has_groupid();
}
inline ::google::protobuf::int32 FieldObjectBasicInfo::groupid() const {
  // @@protoc_insertion_point(field_get:PKS.FieldObjectBasicInfo.groupID)
  return groupid_;
}
inline void FieldObjectBasicInfo::set_groupid(::google::protobuf::int32 value) {
  set_has_groupid();
  groupid_ = value;
  // @@protoc_insertion_point(field_set:PKS.FieldObjectBasicInfo.groupID)
}
